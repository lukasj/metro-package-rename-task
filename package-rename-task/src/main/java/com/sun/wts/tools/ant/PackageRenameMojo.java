 ...
 */
@Mojo(name = "rename", requiresProject = true, defaultPhase = LifecyclePhase.GENERATE_SOURCES, requiresDependencyResolution = ResolutionScope.RUNTIME)
public class PackageRenameMojo extends AbstractMojo {
     ...
     */
    @Parameter(required = true, property = "renamedSourcesDir", defaultValue = "${project.build.directory}/generated-sources/renamed-sources")
     ...
     *
     */
    @Parameter(required = true, property = "srcSourcesDir", defaultValue = "${project.build.directory}/dependency")
    private File srcDir;
